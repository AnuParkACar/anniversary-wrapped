(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function a(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(i){if(i.ep)return;i.ep=!0;const n=a(i);fetch(i.href,n)}})();let d=0,f=[],g=!1,v=!1,w=null;const L=["right","up","right","down","left","up","right","up","down","left","up","right","down","up","right","up","right","down","left"],x={meta:{partnerName:"My Love",years:3,startDate:"2023-02-14"},metrics:[{id:"netflix",label:"Netflix Episodes Watched Together",value:"47",unit:"episodes",icon:"📺"},{id:"hotpot",label:"Hot Pot Dates",value:"12",unit:"amazing dates",icon:"🍲"}],topMoments:[{id:1,title:"PLACEHOLDER",description:"PLACEHOLDER",photo:"photos/moment1.jpg",date:"2025-06-15"},{id:2,title:"PLACEHOLDER",description:"PLACEHOLDER",photo:"photos/moment2.jpg",date:"2025-08-20"},{id:3,title:"PLACEHOLDER",description:"PLACEHOLDER",photo:"photos/moment3.jpg",date:"2025-12-25"}],photos:[],funFacts:[],outroMessage:"PLACEHOLDER: Your heartfelt message 💛"};function A(t,e){const a=Math.min(t,e),s=L[a%L.length];return e<t&&{right:"left",left:"right",up:"down",down:"up"}[s]||s}function S(t){return`
  ...
  `}function z(t){const e=[-4,3,-2];return`
  ...
  `}window.handleReplay=function(){location.reload()};function $(){const t=["💛","💕","✨","💫","🌟","💛"];let e="";for(let a=0;a<20;a++){const s=t[Math.floor(Math.random()*t.length)],i=Math.random()*100,n=Math.random()*100,o=Math.random()*6,c=4+Math.random()*5,l=.8+Math.random()*1.2;e+=`<span class="floating-heart" style="left:${i}%;top:${n}%;animation-delay:${o}s;animation-duration:${c}s;font-size:${l}rem">${s}</span>`}return e}function H(t){return!t||t==="YYYY-MM-DD"?"":new Date(t).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})}function I(t){const e=t.dataset.value,a=parseFloat(e);if(isNaN(a)||e.includes(" ")){t.textContent=e;return}const s=e.includes("."),i=1500,n=performance.now();function o(c){const l=c-n,r=Math.min(l/i,1),u=1-Math.pow(1-r,3),p=a*u;s?t.textContent=p.toFixed(1):t.textContent=Math.floor(p),r<1?requestAnimationFrame(o):t.textContent=e}requestAnimationFrame(o)}window.handleQuizAnswer=function(t,e,a){const s=t.closest(".slide");if(s?.dataset.completed==="true")return;s&&(s.dataset.completed="true");const i=document.querySelectorAll(".quiz-tile"),n=document.getElementById("quiz-result");e===a?(t.classList.add("quiz-correct"),n.innerHTML="🎉 You know us so well!",n.classList.add("show","correct"),Y(t)):(t.classList.add("quiz-wrong"),n.innerHTML=`So close! It was <strong>${a}</strong> 😄`,n.classList.add("show","wrong"),i.forEach(o=>{o.dataset.correct==="true"&&setTimeout(()=>{o.classList.add("quiz-correct","quiz-reveal")},600)})),i.forEach(o=>{o!==t&&o.dataset.correct!=="true"&&o.classList.add("quiz-dimmed")})};function Y(t){const e=t.getBoundingClientRect(),a=e.left+e.width/2,s=e.top+e.height/2,i=["✨","🎉","💛","⭐","🌟","💫"];for(let n=0;n<12;n++){const o=document.createElement("div");o.className="celebration-particle",o.textContent=i[Math.floor(Math.random()*i.length)],o.style.left=a+"px",o.style.top=s+"px";const c=n/12*Math.PI*2,l=60+Math.random()*80;o.style.setProperty("--tx",Math.cos(c)*l+"px"),o.style.setProperty("--ty",Math.sin(c)*l+"px"),o.style.animationDelay=Math.random()*.2+"s",document.body.appendChild(o),setTimeout(()=>o.remove(),1500)}}window.toggleMomentExpand=function(t,e){const a=document.querySelectorAll(".moment-card"),s=t.classList.contains("expanded");a.forEach(i=>i.classList.remove("expanded")),s||t.classList.add("expanded")};document.addEventListener("click",t=>{!t.target.closest(".moment-card")&&!t.target.closest(".moments-grid")&&document.querySelectorAll(".moment-card.expanded").forEach(e=>e.classList.remove("expanded"))});function h(t){if(g||t===d||t<0||t>=f.length)return;g=!0;const e=f[d],a=f[t],s=A(d,t),i={right:"translateX(-100%)",left:"translateX(100%)",up:"translateY(-100%)",down:"translateY(100%)"},n={right:"translateX(100%)",left:"translateX(-100%)",up:"translateY(100%)",down:"translateY(-100%)"};a.querySelectorAll(".animate-target").forEach(u=>{u.classList.remove("animated")}),a.style.transition="none",a.style.transform=n[s],a.style.opacity="1",a.classList.add("active"),a.offsetHeight;const o="0.65s",c="cubic-bezier(0.4, 0, 0.2, 1)";e.style.transition=`transform ${o} ${c}, opacity ${o} ${c}`,e.style.transform=i[s],e.style.opacity="0",a.style.transition=`transform ${o} ${c}, opacity ${o} ${c}`,a.style.transform="translate(0, 0)",a.style.opacity="1",d=t,a.querySelectorAll(".animate-target").forEach((u,p)=>{setTimeout(()=>{u.classList.add("animated")},200+p*120)});const r=a.querySelector(".metric-value[data-value]");r&&setTimeout(()=>I(r),400),j(),e.dataset.slide==="montage"&&F(),a.dataset.slide==="montage"&&setTimeout(()=>R(),800),setTimeout(()=>{e.classList.remove("active"),e.style.transition="",e.style.transform="",e.style.opacity="",a.style.transition="",g=!1},700)}function y(){const t=f[d];t?.dataset.interactive==="true"&&t.dataset.completed!=="true"||d<f.length-1&&h(d+1)}function b(){d>0&&h(d-1)}function j(){document.querySelectorAll(".nav-dot").forEach((e,a)=>{e.classList.toggle("active",a===d)})}function N(t){const e=document.getElementById("nav-dots");e.innerHTML="";for(let a=0;a<t;a++){const s=document.createElement("div");s.className=`nav-dot ${a===0?"active":""}`,s.onclick=()=>{(a<=d||a===d+1)&&h(a)},e.appendChild(s)}}let M=0,T=0;function B(t){M=t.changedTouches[0].screenX,T=t.changedTouches[0].screenY}function G(t){const e=M-t.changedTouches[0].screenX,a=T-t.changedTouches[0].screenY;Math.abs(e)>50&&Math.abs(e)>Math.abs(a)*1.5&&(e>0?y():b())}function X(){const t=document.getElementById("background-music"),e=document.getElementById("music-toggle"),a=s=>{s?(e.classList.remove("muted"),e.querySelector(".music-icon").textContent="🎵"):(e.classList.add("muted"),e.querySelector(".music-icon").textContent="🔇")};e.onclick=s=>{s.stopPropagation(),v?(t.pause(),v=!1,a(!1)):t.play().then(()=>{v=!0,a(!0)}).catch(i=>console.log("Audio play failed:",i))},t.play().then(()=>{v=!0,a(!0),console.log("✅ Autoplay success")}).catch(()=>{console.log("⚠️ Autoplay blocked - waiting for interaction"),v=!1,a(!1);const s=()=>{t.play().then(()=>{v=!0,a(!0),document.removeEventListener("click",s),document.removeEventListener("touchstart",s),document.removeEventListener("keydown",s)}).catch(()=>{})};document.addEventListener("click",s),document.addEventListener("touchstart",s),document.addEventListener("keydown",s)})}function W(){document.addEventListener("keydown",t=>{t.key==="ArrowRight"||t.key===" "?(t.preventDefault(),y()):t.key==="ArrowLeft"?b():t.key==="Escape"&&closeMomentModal()})}async function Q(){try{const t=await fetch("data/metrics.json");if(t.ok){const e=await t.json();return console.log("✅ Loaded metrics.json:",e),e}}catch{console.log("Using sample data (metrics.json not found)")}return x}async function V(){w=await Q();const t=w,e=document.getElementById("app");let a="";a+=S(t);const s=["favorite_show","favorite_restaurant","most_ordered_item"],i=t.metrics.filter(r=>!s.includes(r.id)),n=t.metrics.find(r=>r.id==="favorite_show"),o=["netflix_hours","netflix_sessions","longest_binge","biggest_netflix_day"],c=i.filter(r=>o.includes(r.id));c.forEach((r,u)=>{a+=E(r)}),n&&(a+=q(t)),i.filter(r=>!o.includes(r.id)).forEach((r,u)=>{a+=E(r,c.length+u)}),t.top_5_restaurants&&t.top_5_restaurants.length>0&&(a+=C(t.top_5_restaurants)),a+=k(),t.funFacts&&t.funFacts.length>0&&(a+=D(t.funFacts),window._funFactsTotal=t.funFacts.length),a+=z(t.topMoments),t.photos&&t.photos.length>0&&(a+=_(t.photos)),a+=O(t),a+=P(),e.innerHTML=`<div class="slides-container">${a}</div>`,f=document.querySelectorAll(".slide"),f[0].classList.add("active"),setTimeout(()=>{f[0].querySelectorAll(".animate-target").forEach((r,u)=>{setTimeout(()=>r.classList.add("animated"),u*150)})},300),N(f.length),document.addEventListener("touchstart",B,{passive:!0}),document.addEventListener("touchend",G,{passive:!0}),e.addEventListener("click",r=>{r.target.closest(".moment-card, .modal-overlay, .music-toggle, .nav-dot, .quiz-tile, .fun-fact-card, .wordle-iframe-wrapper, .restaurant-item, .scratch-overlay")||y()}),X(),W(),console.log("🎉 Anniversary Wrapped initialized!")}document.addEventListener("DOMContentLoaded",V);
